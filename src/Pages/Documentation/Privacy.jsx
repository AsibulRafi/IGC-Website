      ...
      <section className="documentation">
        <div className="documentation__content">
          <div className="documentation__content-links">
            ...
            <hr />
            <Link className="link__active" to="/documentation/privacy">
              Privacy Policy
            </Link>
            <hr />
          ...
          <div className="documentation__content-info">
            ...
            <p>
              ...
              www.jmforex.com, and including but not limited to you using any of
              our products, services or applications in any manner, whether
              online or offline.
            </p>
            <p>
            ...
            <p>
              ...
              disclosure, dissemination or otherwise making available, alignment
              or combination, restriction, erasure and/or destruction of
              personal data.
            </p>
            <h2>
            ...
            <p>
              ...
              by you for your data. It is important that the personal data we
              hold about you is accurate, complete and true at all times, as
              such please do keep us informed if your personal data changes
              during your business relationship with any of the entities within
              the Group of Companies. In addition you provide your implied
              consent for data processing/transmission/record keeping/ as
              between the Group of Companies, wherever such entities may be
              located, registered and/or operating.
            </p>
            <h2>THE DATA WE COLLECT ABOUT YOU</h2>
            <p>
              Personal Data, or Personal Information, means any information that
              related to an identified or identifiable living individual. It
              does not include data where the identity has been removed
              (anonymous data). Information can have various ways of being
              obtained, including but not limited to a) information you provide
              us with and/or b) information that we collect; We may collect,
              use, store, process and transfer different kinds of personal data
              about you which we have or may obtain such as Identity Data,
              Contact Data, Financial Data, Transaction Data, Technical Data,
              Profile Data, Usage Data, Marketing and Communication Data. We
            ...
            <p>
              ...
              also collect and process personal data from publicly available
              sources, e.g. the Department of Registrar of Companies, the Land
              Registry, commercial registrars, the Press, media and internet,
              which we lawfully obtain and are permitted to process.
            </p>
            <h2>PURPOSE OF DATA COLLECTION/PERSONAL INFORMATION COLLECTION</h2>
            <p>
              When using the website as an example, details of your data are
              automatically registered by our server, such as your IP address,
              browser, the content you have visited, and how you landed on our
              pages, personal identification information, etc). In addition, we
              collect and store information such as your name, address, e-mail
              address, phone number, date of birth, gender and other data
              transmitted to us through completion of online forms, inserting
              information through the portal, and/or any other newsletters,
              product demos, etc.
            </p>
            <h2>The main purpose of collecting data is:</h2>
            <ul>
              <li>
                Compliance with national and international legal and
                regulatory/supervisory provisions;
              </li>
              <li>
              ...
              <li>Research and statistic analysis;</li>
              <li>Facilitation of technical administration;</li>
              <li>
                To take into consideration your online website behavior and
                trend;
              </li>
              <li>Improve the quality of services and develop new ones;</li>
              <li>Improve security by protecting against fraud and abuse;</li>
              <li>
                To provide you with the transaction and post transaction-related
                services;
              </li>
              <li>
                To inform you of products and/or services that may be of
                interest to you;
              </li>
              <li>Ensuring network and information security;</li>
              <li>
                All personal data is stored in accordance with the applicable
            ...
            <p>
              ...
              professional advisers, which may be located overseas, such as
              auditors, lawyers and accountants, any third parties where this is
              necessary to process a transaction or provide services which you
              have requested or for trade reporting purposes.
            </p>
            ...
            <p>
              It should be noted that data transmitted via an open network like
              the Internet cannot be fully protected from third-party access,
              although we take the best possible precautions to avoid any
              leakage of information/data. Any transmission of data via the
              internet is at your own risk, although we will exercise all ways
            ...
            <p>
              ...
              cookies such as ID cookies which do not expire when you close your
              browser, and persistent cookies with remains on your hard drive
              for a period of time. If you do not wish to receive cookies, you
              may be able to change the settings of your browser to refuse all
              cookies or to have your device notify you each time a cookie is
              sent to it, and thereby the choice to accept it or not. It is
              strongly recommended that you allow cookies on our website to
              ensure you have best possible experience. Disabling the cookies
              may result in reduced performance of the website and trading
              platform, and may also impair the quality of the services that we
              provide you in relation to your account with us.
            </p>
            <h2>THIRD PARTY LINKS</h2>
            <p>
              Links may appear on the website that are not operated or monitored
              by us, known as “third-party websites”, whereby such third party
              websites are not bound by this privacy policy and we are not
              responsible for their content. No warranties or liability related
              to the contents of such third party websites are made. Using links
              to third-party websites are at your own sole risk and discretion.
            </p>
            <h2>GOVERNING LAW</h2>
            <p>
              The use of this website shall be governed by the laws of Cyprus
              and/or the applicable law of the entity in which the User proceeds
              to open account with based on written agreement.
            </p>
            ...
            <p>
              To exercise you rights you can contact the Company in which you
              have executed agreement or intend to form agreement or are
              interested in and the relevant Company will take action based on
              request.
            </p>
          </div>
        </div>
